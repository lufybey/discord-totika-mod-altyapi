...
if(!member) return message.channel.send(new Discord.RichEmbed().setColor(client.randomrenk()).setAuthor(message.author.tag , message.author.avatarURL).setDescription("Sesten kimi atmak istersiniz veya id girerek işlem yapabilirsiniz."))
    ...
    let kanal = member.voiceChannels.id
