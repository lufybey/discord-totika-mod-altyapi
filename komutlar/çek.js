...
if(!kisi.voiceChannel) return message.channel.send(new Discord.RichEmbed().setColor(client.randomrenk()).setDescription('Çekmek istediğiniz üye bir ses kanalında değil.').setColor('RANDOM'))
